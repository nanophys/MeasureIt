...
class Ui_MeasureIt(object):
    def setupUi(self, MeasureIt):
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(200, 20, 111, 143))
        ...
        self.livePlotBox = QtWidgets.QCheckBox(self.layoutWidget1)
        self.livePlotBox.setChecked(True)
        self.livePlotBox.setObjectName("livePlotBox")
        self.verticalLayout_3.addWidget(self.livePlotBox)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.plotbinLabel = QtWidgets.QLabel(self.layoutWidget1)
        self.plotbinLabel.setObjectName("plotbinLabel")
        self.horizontalLayout.addWidget(self.plotbinLabel)
        self.plotbinEdit = QtWidgets.QLineEdit(self.layoutWidget1)
        self.plotbinEdit.setObjectName("plotbinEdit")
        self.horizontalLayout.addWidget(self.plotbinEdit)
        ...
        self.startButton = QtWidgets.QPushButton(self.scanGroupBox)
        self.startButton.setGeometry(QtCore.QRect(20, 170, 81, 23))
        self.startButton.setObjectName("startButton")
        self.pauseButton = QtWidgets.QPushButton(self.scanGroupBox)
        self.pauseButton.setGeometry(QtCore.QRect(130, 170, 71, 23))
        self.pauseButton.setObjectName("pauseButton")
        self.endButton = QtWidgets.QPushButton(self.scanGroupBox)
        self.endButton.setGeometry(QtCore.QRect(230, 170, 71, 23))
        self.endButton.setObjectName("endButton")
        self.parameterGroupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.parameterGroupBox.setGeometry(QtCore.QRect(10, 10, 361, 441))
        ...
        self.pushButton.setGeometry(QtCore.QRect(650, 250, 51, 22))
        self.pushButton.setObjectName("pushButton")
        self.layoutWidget2 = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget2.setGeometry(QtCore.QRect(370, 270, 358, 116))
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(371, 251, 271, 21))

...
class Sweep0D(BaseSweep):
    ...
    def __init__(
        ...
        """
        super().__init__(
            set_param, inter_delay=inter_delay, save_data=save_data, plot_data=plot_data
        )
...
class Runner(QObject):
    ...
    def add_plotter(self, plotter):
        ...
        """
        self.plotter = plotter
        self.new_data_ready.connect(self.plotter.update)
    ...
    def set_database(self):
        ...
        try:
            initialise_or_create_database_at(
                "C:\\Users\\Nanouser\\Documents\\measureit.Databases\\" + db + ".db"
            )

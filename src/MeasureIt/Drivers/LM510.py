...
class LM510(IPInstrument):
    def __init__(
        self, name, address="192.168.1.152", port=4266, timeout=5, *args, **kwargs
    ):
        ...
        self.add_parameter(
            "pressure", label="Pressure", unit="psi", parameter_class=GroupParameter
        )
        ...
        self.measure_group = Group(
            [self.pressure, self.heater_output],

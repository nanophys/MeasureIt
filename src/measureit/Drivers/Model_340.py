...
class Model_340_Channel(InstrumentChannel):
    ...
    def __init__(self, parent, name, channel):
        ...
        self.add_parameter(
            ...
            get_cmd="MODE?",
            set_cmd="MODE {{mode}}",
            val_mapping={"local": 1, "remote": 2, "remote and locked": 3},
        )
        ...
        self.add_parameter(
            ...
            val_mapping={"Special": 0, "volts": 1, "ohms": 2},
            parameter_class=GroupParameter,
        )
        ...
        self.add_parameter(
            ...
            val_mapping={"Special": 0, "negative": 1, "positive": 2},
            parameter_class=GroupParameter,
        )
        ...
        self.sensor_group = Group(
            [
                self.sensor_type,
                self.sensor_units,
                self.sensor_coefficient,
                self.sensor_excitation,
                self.sensor_range,
            ],
        ...
        self.input_group = Group(
            [self.input_enabled, self.input_compensation],
...
class Loop_340(InstrumentChannel):
    ...
    def __init__(self, parent, output_name, loop, has_pid: bool = True) -> None:
        ...
        self.output_group = Group(
            [self.input_channel, self.units, self.enabled, self.powerup_enable],
...
class Model_340(LakeshoreBase):
    ...
    input_channel_parameter_values_to_channel_name_on_instrument = channel_name_command
